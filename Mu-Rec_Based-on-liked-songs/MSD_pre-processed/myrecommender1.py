...
class PopularityRecommender:
    ...
    def recommend(self, user_id):
        ...
        # Filter the original data to get detailed information for the recommended songs
        recommended_songs_info = self.train_data[self.train_data[self.item_id].isin(user_recommendations[self.item_id])]

        # Display additional information along with the recommendations
        recommended_songs_info = recommended_songs_info[['song', 'title', 'artist_name', 'year', 'listen_count', 'Rank']]
